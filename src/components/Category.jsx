  ...
  return (
    <div className='max-w-screen-2xl mx-auto container xl:px-28 px-4 py-28'>
      ...
      <div className='mt-8 flex flex-col md:flex-row items-center gap-4'>
        <p className='font-semibold uppercase md:-rotate-90 text-center bg-rose-400 text-white md:p-1.5 p-2 rounded-sm inline-flex'>Descubri los nuevas y populares estilos</p>
        <div>
